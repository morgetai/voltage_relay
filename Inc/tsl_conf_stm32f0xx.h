...
*/
#define TSLPRM_TOTAL_TOUCHKEYS (5)
...
*/
#define TSLPRM_DEBOUNCE_PROX (10)
...
*/
#define TSLPRM_DEBOUNCE_RELEASE (10)
...
/** Spread Spectrum Deviation (range=0..127)
    ...
    - 127: 128 x tSSCLK
*/
#define TSLPRM_TSC_SSD (1)

/** Spread Spectrum Prescaler (range=0..1)
    - 0: fSSCLK = fHCLK
    - 1: fSSCLK = fHCLK/2
*/
#define TSLPRM_TSC_SSPSC (1)
